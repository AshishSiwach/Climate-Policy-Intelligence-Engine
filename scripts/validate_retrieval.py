...
from retrieval import BM25Retriever, DenseRetriever, HybridRetriever, Reranker  # noqa: E402
...
PILOT_DOCS = [
    {
        "path": ROOT
        / "data/raw/Smart-Secure-Electricity-Systems-Implementing-the-load-control-licensing-regime-consultation.pdf",
